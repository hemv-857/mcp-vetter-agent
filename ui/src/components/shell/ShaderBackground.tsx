...
// ShaderBackground — generated by the 21st.dev Shader Builder ("Plasma").
// Zero dependencies: one WebGL canvas that fills its parent.
//
// Vendored as generated. The recipe is the artist's: measured against this
// console's tokens, the hue rotation already lands the palette at a deep navy
// (#162852 mean), which is the graphite/blue family the design system is built
// in, so there was nothing to retune. Two changes only, both forced by the
// codebase rather than by taste — a reduced-motion gate, and the non-null
// assertions `render` needs under this tsconfig. Readability is handled where
// it belongs, at the mount: see BackgroundField.
...
export function ShaderBackground({ className }: { className?: string }) {
  ...
  // Stops the clock and paints one still frame. A background that must not
  // move is a still image, not a black rectangle.
